...
<nav class="navbar navbar-inverse" style="position:fixed;top:0;right:0;left:0;z-index: 2;">
    <div class="container-fluid" style="width: 1040px;">
        <div class="navbar-header" style="float: <?php echo lang('float'); ?>;">
            ...
            <a class="navbar-brand" style="font-weight:bold" href="<?php echo $dircheckPath; ?>home">ASTRAL</a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="<?php echo lang('ul_navbar_nav1'); ?>">
                ...
                ?>
                <li><a href="<?php echo $homePath; ?>" style="padding: 14px 10px;"><span style="font-weight:bold;font-size: 17px;" class="fa fa-home"></span> <?php echo lang('navbar_home'); ?></a></li>
                <li><a href="javascript:void(0);" style="font-weight:bold;padding: 16px 10px;" id="nav_Noti_Btn"><span class="fa fa-bell"></span> <?php echo lang('notifications'); ?> <span id="notificationsCount"></span></a>
                ...
                <li><a href="<?php echo $dircheckPath; ?>messages/" style="font-weight:bold;padding: 16px 10px;"><span class="fa fa-envelope"></span> <?php echo lang('messages'); ?> <span id="messagesCount"></span></a>
                </li>
            </ul>
