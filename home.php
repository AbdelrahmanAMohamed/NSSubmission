...
<head>
    ...
    <meta name="author" content="Astral Scythe">
...
<div align="center">
  ...
  <h3 style="margin:5px;font-size:18px;font-weight:bold"><?php echo "<a href='u/".$_SESSION['Username']."'>".$_SESSION['Fullname']."</a>"; if ($_SESSION['verify'] == "1"){echo $verifyUser;} ?></h3>
